...
# def greeks_heatmaps(S, r, sigma, option_type, strike_range, time_range):
    
#     data = {"Strike": [], "Time to Maturity": [], "Delta": [], "Gamma": [], "Vega": [], "Theta": [], "Rho": []}

#     for K in strike_range:
#         for T in time_range:
#             greeks = black_scholes_greeks(S, K, r, T, sigma, option_type)
#             data["Strike"].append(K)
#             data["Time to Maturity"].append(T)
#             for greek in greeks:
#                 data[greek].append(greeks[greek])
